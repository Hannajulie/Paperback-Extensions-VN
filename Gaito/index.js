...
class Gaito extends paperback_extensions_common_1.Source {
    ...
    getMangaShareUrl(mangaId) { return `https://www.gaito.io/truyen-hentai/comic/${mangaId}`; }
    ;
    ...
    getHomePageSections(sectionCallback) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let request = createRequestObject({
                url: 'https://api.gaito.io/manga/comics?limit=20&offset=0&sort=latest',
                method: "GET",
            });
            let newUpdatedItems = [];
            ...
            request = createRequestObject({
                url: 'https://api.gaito.io/manga/comics?limit=20&offset=0&sort=top-rated',
                method: "GET",
            });
            let newAddItems = [];
